                ...
                <div className="flex flex-col jusitfy-center items-center space-y-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 w-full ">
                    <div className="relative group flex justify-center items-center h-full w-full">
                      <img
                        className="object-center object-cover h-full rounded-xl w-full"
                    ...
                    <div className="relative group flex justify-center items-center h-full w-full mt-4 md:hidden md:mt-8 lg:hidden">
                      <img
                        className="object-center object-cover h-full rounded-xl w-full hidden md:block"
                        src="https://res.cloudinary.com/dhybspk1v/image/upload/v1679671746/bi0shardware/img4_gunf8f.jpg"
                        alt="girl-image"
                      />
                      <img
                        className="object-center object-cover h-full rounded-xl w-full md:hidden"
                        src="https://res.cloudinary.com/dhybspk1v/image/upload/v1679671746/bi0shardware/img4_gunf8f.jpg"
                  ...
                  <div className="relative group hidden md:flex justify-center items-center h-full w-full mt-4 md:mt-8 lg:hidden">
                    ...
                    />
                    <img
                      className="object-center object-cover h-full  rounded-xl w-full sm:hidden"
                      src="https://res.cloudinary.com/dhybspk1v/image/upload/v1679671746/bi0shardware/img4_gunf8f.jpg"
                      alt="olive-tatiane-Im-Ez-F9-B91-Mk-unsplash-2"
                    />
                  </div>
